# M8 BUSINESS FUEL DONE

Branch: `feature/m8-business-fuel`
...
```text
m8-golden-tests-coverage-zh.png    size=7991110  IDAT=1947
m8-knowledge-overview-zh.png       size=8025266  IDAT=1955
m8-knowledge-upload-zh.png         size=8037185  IDAT=1958
m8-rules-candidates-review-zh.png  size=8262293  IDAT=2013
m8-rules-overview-zh.png           size=8267546  IDAT=2014
m8-rules-version-rollback-zh.png   size=8252482  IDAT=2010
```

## Database Evidence

Migration applied: `20260522203000_m8_business_fuel`

```text
rule_candidates: 11
rule_versions: 1
prompt_quality_reports: 1
```

## Collector Run Evidence

`pnpm --config.engine-strict=false --dir apps/worker exec tsx src/jobs/data-collection/m5-ingest-runner.ts`

```text
totalJobs: 10
rule-curation candidate pool rows after run: 11
```
