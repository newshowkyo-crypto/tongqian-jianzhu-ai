...
export default function Page(): JSX.Element {
  return (
    <PageLayout className="bg-stitch-surface text-stitch-on-surface">
      <PageContent>
        <PageHeader title="???" description="TBD_TEXT" breadcrumbs="?? / ???" actions={<button className="rounded-md bg-stitch-primary-container px-4 py-2 text-sm font-medium text-white">AI ??</button>} />
