  ...
  return (
    <main className="min-h-screen bg-[#101820] p-6 text-white">
      <header className="space-y-2">
        ...
        <div className="flex gap-3 text-sm"><span className="rounded-md bg-white/10 px-3 py-2">AI 风险点</span><span className="rounded-md bg-[#d6ad60] px-3 py-2 text-black">38 项强制扫描</span></div>
      </header>
