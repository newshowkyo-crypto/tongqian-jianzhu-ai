...
export class CostEstimateController {
  constructor(
    @Inject(CostEstimateService) private readonly costs: CostEstimateService,
    @Inject(BudgetEstimatorService) private readonly budgets: BudgetEstimatorService,
    @Inject(RoughQuantityService) private readonly roughQuantities: RoughQuantityService,
  ) {}
