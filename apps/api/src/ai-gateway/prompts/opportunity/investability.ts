...
/**
 * M3.7 value-density self-check for opportunity investability.
...
export const opportunityInvestabilityPrompt = createConstructionPrompt({
  costCredits: 300,
  description: 'opportunity investability prompt template with M3.7 construction controls, M3.12 domestic flagship routing, JSON schema output, and value-density audit.',
  fallbackModel: 'qwen3-max',
  governmentOnly: false,
  knowledge: promptAuditPack,
  primaryModel: 'qwen3-max',
  taskType: AiTaskType.OPP_INVESTABILITY,
  title: 'opportunity investability',
