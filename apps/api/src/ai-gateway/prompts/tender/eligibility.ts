...
/**
 * M3.7 value-density self-check for tender eligibility.
...
export const tenderEligibilityPrompt = createConstructionPrompt({
  costCredits: 800,
  description: 'tender eligibility prompt template with M3.7 construction controls, M3.12 domestic flagship routing, JSON schema output, and value-density audit.',
