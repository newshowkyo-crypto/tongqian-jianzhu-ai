...
/**
 * M3.7 value-density self-check for site archive checklist.
...
export const siteArchiveChecklistPrompt = createConstructionPrompt({
  costCredits: 300,
  description: 'site archive checklist prompt template with M3.7 construction controls, M3.12 domestic flagship routing, JSON schema output, and value-density audit.',
  fallbackModel: 'qwen3-max',
  governmentOnly: false,
  knowledge: promptAuditPack,
  primaryModel: 'qwen3-max',
  taskType: AiTaskType.SITE_ARCHIVE_CHECKLIST,
  title: 'site archive checklist',
