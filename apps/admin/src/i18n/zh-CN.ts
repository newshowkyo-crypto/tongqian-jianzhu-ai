export const zhCN = {
  ...
  navigation: {
    ...
    items: [
      ...
      { href: '/ingest', icon: 'operations', label: 'Ingest overview' },
      { href: '/ingest/regulations', icon: 'rules', label: 'Regulations ingest' },
      { href: '/ingest/tenders', icon: 'operations', label: 'Tenders ingest' },
      { href: '/ingest/policies', icon: 'billing', label: 'Policies ingest' },
      { href: '/ingest/templates', icon: 'prompts', label: 'Templates ingest' },
      { href: '/ingest/court-judgments', icon: 'audit', label: 'Court CSV ingest' },
      { href: '/ingest/tianyancha', icon: 'credentials', label: 'Tianyancha ingest' },
      { href: '/ingest/ocr', icon: 'models', label: 'OCR ingest' },
    ],
  },
  permissions: {
    title: '权限点开关',
