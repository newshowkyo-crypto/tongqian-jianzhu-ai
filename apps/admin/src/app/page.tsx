    ...
    <section className="space-y-6 text-white">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <a key={href} className="rounded-md border border-[var(--border-silver)] bg-white/5 p-5 shadow-card transition-shadow hover:shadow-md" href={href}>
        ...
        <section className="rounded-md border border-[var(--border-silver)] bg-white/5 p-5 shadow-card">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-lg font-semibold">{zhCN.home.credentials.title}</h2>
            <a className="rounded-md border border-[var(--border-silver)] px-3 py-2 text-sm" href="/admin/credentials">{zhCN.home.credentials.new}</a>
          </div>
