...
const moduleKey = 'security' as const;

const adminPageContract = {
  api: {
    clientPackage: '@tongqian/api-client',
    queryKey: ['admin', moduleKey, 'list'],
    listEndpoint: '/api/v1/admin/security',
    detailEndpoint: '/api/v1/admin/security/{id}',
    mutationEndpoint: '/api/v1/admin/security',
  ...
  layout: {
    ...
    breadcrumbsKey: 'admin.navigation.security',
    titleKey: 'admin.pages.security.title',
    descriptionKey: 'admin.pages.security.description',
  },
  filters: [
  ...
  rowActions: [
    { key: 'openDrawer', labelKey: 'admin.actions.openDrawer', permission: 'security:read' },
    { key: 'approve', labelKey: 'admin.actions.approve', permission: 'security:approve' },
    { key: 'rollback', labelKey: 'admin.actions.rollback', permission: 'security:rollback' },
  ],
  states: {
    loadingKey: 'admin.states.loading',
    errorKey: 'admin.states.error',
    emptyKey: 'admin.states.empty',
    successToastKey: 'admin.toast.security.success',
    errorToastKey: 'admin.toast.security.error',
  },
  safeguards: {
    whereGuard: ['tenant_id', 'scope_type', 'project_id', 'owner_id'],
    auditEvents: ['security.list', 'security.detail', 'security.mutate', 'security.export'],
  ...
  seedRows: [
    { id: 'security-001', status: 'active', risk: 'medium', owner: 'platform-owner', traceId: 'm37-security-001' },
    { id: 'security-002', status: 'processing', risk: 'high', owner: 'ops-admin', traceId: 'm37-security-002' },
    { id: 'security-003', status: 'completed', risk: 'low', owner: 'audit-bot', traceId: 'm37-security-003' },
  ],
  apiClientUsage: [
    'adminClient.security.list(filters)',
    'adminClient.security.detail(id)',
    'adminClient.security.mutate(payload, idempotencyKey)',
