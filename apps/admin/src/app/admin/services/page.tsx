...
const moduleKey = 'services' as const;

const adminPageContract = {
  api: {
    clientPackage: '@tongqian/api-client',
    queryKey: ['admin', moduleKey, 'list'],
    listEndpoint: '/api/v1/admin/services',
    detailEndpoint: '/api/v1/admin/services/{id}',
    mutationEndpoint: '/api/v1/admin/services',
  ...
  layout: {
    ...
    breadcrumbsKey: 'admin.navigation.services',
  ...
  rowActions: [
    { key: 'openDrawer', labelKey: 'admin.actions.openDrawer', permission: 'services:read' },
    { key: 'approve', labelKey: 'admin.actions.approve', permission: 'services:approve' },
    { key: 'rollback', labelKey: 'admin.actions.rollback', permission: 'services:rollback' },
  ],
  states: {
    loadingKey: 'admin.states.loading',
    errorKey: 'admin.states.error',
    emptyKey: 'admin.states.empty',
    successToastKey: 'admin.toast.services.success',
    errorToastKey: 'admin.toast.services.error',
  },
  safeguards: {
    whereGuard: ['tenant_id', 'scope_type', 'project_id', 'owner_id'],
    auditEvents: ['services.list', 'services.detail', 'services.mutate', 'services.export'],
  ...
  seedRows: [
    { id: 'services-001', status: 'active', risk: 'medium', owner: 'platform-owner', traceId: 'm37-services-001' },
    { id: 'services-002', status: 'processing', risk: 'high', owner: 'ops-admin', traceId: 'm37-services-002' },
    { id: 'services-003', status: 'completed', risk: 'low', owner: 'audit-bot', traceId: 'm37-services-003' },
  ],
  apiClientUsage: [
    'adminClient.services.list(filters)',
    'adminClient.services.detail(id)',
    'adminClient.services.mutate(payload, idempotencyKey)',
