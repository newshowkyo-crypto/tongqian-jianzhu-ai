...
const moduleKey = 'credits' as const;

const adminPageContract = {
  api: {
    clientPackage: '@tongqian/api-client',
    queryKey: ['admin', moduleKey, 'list'],
    listEndpoint: '/api/v1/admin/credits',
    detailEndpoint: '/api/v1/admin/credits/{id}',
    mutationEndpoint: '/api/v1/admin/credits',
  ...
  layout: {
    ...
    breadcrumbsKey: 'admin.navigation.credits',
    titleKey: 'admin.pages.credits.title',
    descriptionKey: 'admin.pages.credits.description',
  },
  filters: [
  ...
  rowActions: [
    { key: 'openDrawer', labelKey: 'admin.actions.openDrawer', permission: 'credits:read' },
    { key: 'approve', labelKey: 'admin.actions.approve', permission: 'credits:approve' },
    { key: 'rollback', labelKey: 'admin.actions.rollback', permission: 'credits:rollback' },
  ],
  states: {
    loadingKey: 'admin.states.loading',
    errorKey: 'admin.states.error',
    emptyKey: 'admin.states.empty',
    successToastKey: 'admin.toast.credits.success',
    errorToastKey: 'admin.toast.credits.error',
  },
  safeguards: {
    whereGuard: ['tenant_id', 'scope_type', 'project_id', 'owner_id'],
    auditEvents: ['credits.list', 'credits.detail', 'credits.mutate', 'credits.export'],
  ...
  seedRows: [
    { id: 'credits-001', status: 'active', risk: 'medium', owner: 'platform-owner', traceId: 'm37-credits-001' },
    { id: 'credits-002', status: 'processing', risk: 'high', owner: 'ops-admin', traceId: 'm37-credits-002' },
    { id: 'credits-003', status: 'completed', risk: 'low', owner: 'audit-bot', traceId: 'm37-credits-003' },
  ],
  apiClientUsage: [
    'adminClient.credits.list(filters)',
    'adminClient.credits.detail(id)',
    'adminClient.credits.mutate(payload, idempotencyKey)',
