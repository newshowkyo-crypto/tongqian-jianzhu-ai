...
const moduleKey = 'tenants' as const;

const adminPageContract = {
  api: {
    clientPackage: '@tongqian/api-client',
    queryKey: ['admin', moduleKey, 'list'],
    listEndpoint: '/api/v1/admin/tenants',
    detailEndpoint: '/api/v1/admin/tenants/{id}',
    mutationEndpoint: '/api/v1/admin/tenants',
  ...
  layout: {
    ...
    breadcrumbsKey: 'admin.navigation.tenants',
    titleKey: 'admin.pages.tenants.title',
    descriptionKey: 'admin.pages.tenants.description',
  },
  filters: [
  ...
  rowActions: [
    { key: 'openDrawer', labelKey: 'admin.actions.openDrawer', permission: 'tenants:read' },
    { key: 'approve', labelKey: 'admin.actions.approve', permission: 'tenants:approve' },
    { key: 'rollback', labelKey: 'admin.actions.rollback', permission: 'tenants:rollback' },
  ],
  states: {
    loadingKey: 'admin.states.loading',
    errorKey: 'admin.states.error',
    emptyKey: 'admin.states.empty',
    successToastKey: 'admin.toast.tenants.success',
    errorToastKey: 'admin.toast.tenants.error',
  },
  safeguards: {
    whereGuard: ['tenant_id', 'scope_type', 'project_id', 'owner_id'],
    auditEvents: ['tenants.list', 'tenants.detail', 'tenants.mutate', 'tenants.export'],
  ...
  seedRows: [
    { id: 'tenants-001', status: 'active', risk: 'medium', owner: 'platform-owner', traceId: 'm37-tenants-001' },
    { id: 'tenants-002', status: 'processing', risk: 'high', owner: 'ops-admin', traceId: 'm37-tenants-002' },
    { id: 'tenants-003', status: 'completed', risk: 'low', owner: 'audit-bot', traceId: 'm37-tenants-003' },
  ],
  apiClientUsage: [
    'adminClient.tenants.list(filters)',
    'adminClient.tenants.detail(id)',
    'adminClient.tenants.mutate(payload, idempotencyKey)',
