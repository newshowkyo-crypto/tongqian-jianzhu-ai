...
CREATE INDEX "gov_audit_logs_trace_id_created_at_idx" ON "gov_audit_logs"("trace_id", "created_at");
...
CREATE INDEX "fraud_signals_type_level_status_idx" ON "fraud_signals"("type", "level", "status");
...
CREATE INDEX "backup_runs_run_type_status_started_at_idx" ON "backup_runs"("run_type", "status", "started_at");
...
CREATE TABLE "compliance_self_checks" (
  "id" UUID NOT NULL,
...
CREATE UNIQUE INDEX "compliance_self_checks_quarter_key" ON "compliance_self_checks"("quarter");
...
CREATE UNIQUE INDEX "ai_data_sources_source_name_key" ON "ai_data_sources"("source_name");
