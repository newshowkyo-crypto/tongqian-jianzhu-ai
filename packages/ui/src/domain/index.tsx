...
const assistantRoleConfig: Record<AiAssistantRole, { accent: string; fullPageHref: string; greeting: string; icon: string; placeholder: string; roleLabel: string; title: string }> = {
  admin: { accent: 'from-[#0a1d3d] via-[#1e3a6f] to-[#4a8eff]', fullPageHref: '/assistant', greeting: '\u6211\u662f\u8fd0\u8425\u987e\u95ee\uff0c\u53ef\u4ee5\u534f\u52a9\u67e5\u770b\u7ea2\u7ebf\u544a\u8b66\u3001\u53cd\u8585\u7b56\u7565\u3001\u5ba2\u6237\u6210\u529f SOP \u548c\u6a21\u578b\u8def\u7531\u5065\u5eb7\u3002', icon: '\u8fd0', placeholder: '\u8f93\u5165\u8fd0\u8425\u95ee\u9898', roleLabel: '\u5e73\u53f0\u8fd0\u8425', title: '\u8fd0\u8425\u987e\u95ee' },
  gov: { accent: 'from-[#4b0f1b] via-[#142a52] to-[#0a1d3d]', fullPageHref: '/assistant', greeting: '\u6211\u662f\u653f\u7b56\u667a\u5e93\u3002\u653f\u4f01\u6750\u6599\u8d70\u56fd\u4ea7\u6a21\u578b\u4e0e\u72ec\u7acb\u5ba1\u8ba1\uff0c\u6570\u636e\u4e0d\u51fa\u5883\u3002', icon: '\u653f', placeholder: '\u8f93\u5165\u653f\u7b56\u6216\u516c\u6587\u95ee\u9898', roleLabel: '\u653f\u4f01\u4e13\u5c5e', title: '\u653f\u7b56\u667a\u5e93' },
  owner: { accent: 'from-[#0a1d3d] via-[#1e3a6f] to-[#d99880]', fullPageHref: '/chat-hub', greeting: '\u6211\u662f\u7ba1\u5bb6\u5c0f\u540c\u3002\u5408\u540c\u3001\u62db\u6807\u3001\u8d44\u8d28\u3001\u8d44\u91d1\u548c\u7ecf\u8425\u98ce\u9669\u90fd\u53ef\u4ee5\u5148\u95ee\u6211\u3002', icon: '\u540c', placeholder: '\u95ee\u6211\u4e00\u4e2a\u7ecf\u8425\u95ee\u9898', roleLabel: '\u5efa\u7b51\u8001\u677f AI \u7ecf\u8425\u7ba1\u5bb6', title: '\u7ba1\u5bb6\u5c0f\u540c' },
  steward: { accent: 'from-[#142a52] via-[#4a8eff] to-[#d99880]', fullPageHref: '/assistant', greeting: '\u6211\u662f\u6d3e\u5355\u8001\u53f8\u673a\u3002\u62a5\u4ef7\u3001\u8bdd\u672f\u3001\u8dd1\u529e\u548c\u5e73\u53f0\u89c4\u5219\u90fd\u53ef\u4ee5\u95ee\uff0c\u79c1\u4e0b\u7ed5\u5e73\u53f0\u7684\u505a\u6cd5\u4e0d\u63d0\u4f9b\u3002', icon: '\u5355', placeholder: '\u8f93\u5165\u6d3e\u5355\u6216\u62a5\u4ef7\u95ee\u9898', roleLabel: '\u667a\u80fd\u7ba1\u5bb6\u52a9\u624b', title: '\u6d3e\u5355\u8001\u53f8\u673a' },
};
...
export function AiReportH5Card({ className, title }: { className?: string; title: ReactNode }): ReactNode {
  return <Card className={cn('mx-auto max-w-[375px] overflow-hidden', className)}><div className="bg-[#0a1d3d] p-4 text-white"><h1 className="text-xl font-bold">{title}</h1><TierBadge className="mt-2" tier={2} /></div><CardContent className="space-y-4 pt-4"><ContractRiskItem level="yellow" text={'\u53d1\u73b0\u9700\u8981\u590d\u6838\u7684\u5173\u952e\u98ce\u9669\u3002'} /><ConfidenceDots score={3} /><p className="text-xs text-[var(--text-secondary)]">AI {'\u751f\u6210\u5185\u5bb9\u4ec5\u4f9b\u7ecf\u8425\u51b3\u7b56\u53c2\u8003\u3002'}</p></CardContent></Card>;
}
