...
export { AiReportFooter } from './AiReportFooter.js';
export type { AiReportAudience } from './AiReportFooter.js';
  ...
  return (
    <Card className={cn('mx-auto max-w-3xl', className)}>
      <CardContent className="space-y-4 pt-4">
        <ReportHeader requiredElements={requiredElements} title={title} />
        {children}
        <DisclaimerFooter>{requiredElements.disclaimer}</DisclaimerFooter>
      </CardContent>
    </Card>
  );
}

export function ReportFullPdf({
  children,
  className,
  requiredElements,
  title,
  ...
  return (
    <article className={cn('mx-auto max-w-4xl space-y-6 bg-white p-8 text-neutral-900', className)}>
      <ReportHeader requiredElements={requiredElements} title={title} />
      {children}
      <DisclaimerFooter>{requiredElements.disclaimer}</DisclaimerFooter>
    </article>
